...
app.MapGet("/send-email", async (IOptions<AuthMessageSenderOptions> optionsAccessor) =>
{
    var api = new MandrillApi(optionsAccessor.Value.EmailAuthKey);
    var mandrillMessage = new MandrillMessage("no_reply@hotcliq.com", "luke@lukelatham.com", "Test Email Message", "Hello from TEST message!");
